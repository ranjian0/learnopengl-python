...
def main():
    ...
    lighting_shader = Shader(CURDIR / "shaders/4.3.lighting_maps.vs", CURDIR / "shaders/4.3.lighting_maps.fs")
    ...
    emission_map = load_texture("matrix.jpg")
    ...
    while not glfw.window_should_close(window):
        ...
        gl.glBindTexture(gl.GL_TEXTURE_2D, emission_map)
