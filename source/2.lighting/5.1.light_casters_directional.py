...
def main():
    ...
    lighting_shader = Shader(CURDIR / "shaders/5.1.light_casters.vs", CURDIR / "shaders/5.1.light_casters.fs")
    ...
    while not glfw.window_should_close(window):
        ...
        lighting_shader.use()
        lighting_shader.set_vec3("light.direction", Vector3([-0.2, -1.0, -0.3]))
